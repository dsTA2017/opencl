...
int main(int argc,char** argv)
{
    ...
    cl_program program = load_program(context, "/Users/yang50309/Desktop/openc++/openc++/sobel.cl");  ///Users/yang50309/Desktop/openc++/openc++/
    if(program == 0) {
    ...
    */
    ...
    VideoCapture video("/Users/yang50309/Desktop/openc++/openc++/car.mp4");
    if (!video.isOpened()){
        return -1;
    }
